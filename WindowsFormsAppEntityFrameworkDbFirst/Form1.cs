...
namespace WindowsFormsAppEntityFrameworkDbFirst
{
    public partial class Form1 : Form
    {
        ...
        // Entity Framework
        /*
            >> Entity Framework OMR(Object Relational Mapping) araçlarından biridir. Veritabanı CRUD işlemlerini Sql sorgusu yazmadan Linq dili ile hazır metotları kullanarak yapabilmemizi sağlar.
            ...
            > Database First (Var olan veritabnını kullanma)
            > Code First (Önce Entity class Larımızı oluşturup sonra veritabanı oluşturarak)
            > Code Frist (Var olan veritabanını kullanarak Entity classlarını oluşturarak)
         */
        ...
        {
            dgvUrunler.DataSource = context.Products.ToList(); // EF ile context nesnesi üzerindeki Products dbset ine ulaşıp veritabanındaki ürüneleri listeledik 
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Entity Framework de tracking denilen bir kavram var ve bu tracking ef context üzerindeki değişiklikleri izler, taklit eder, saveChanges i çalıştırdığımızda db ye işler  

                if (sonuc > 0) // context.SaveChanges() metodu geriye veritabanında etkilenen kayıt sırasını int olarak bize döndürür. sonuc değişkenine bu değeri atadık ve if ile bu değer 0 dan büyük mü diye kontrol ettik. Eğer silme başarılıysa sonuc değeri 1 olacaktır, başarısız olursa 0 olacaktır. 
                {
                    dgvUrunler.DataSource = context.Products.ToList();
