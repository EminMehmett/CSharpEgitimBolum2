...
namespace AspNetFrameworkMVC.Controllers
{
    public class MVC14FiltersUsingController : Controller
    {
        ...
        [UserControl] // Index actionuna istek gelince UserControl class ı içerisindeki mekanizma oraya yazdığımız session ve cookie kurallarına bakarak kullanıcı giriş yapmışsa sayfayı açacak, yapmamışsa istediğimiz bir sayfaya yönlendirecek 
